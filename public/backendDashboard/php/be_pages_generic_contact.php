...
<!-- Mirrored from demo.pixelcave.com/codebase/be_pages_generic_contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 22:23:16 GMT -->
...
<body><div id="page-container" class="sidebar-o side-scroll page-header-glass page-header-inverse main-content-boxed">
...
<li>
<a href="../be_pages_generic_profile.html">
<img class="img-avatar" src="../jpg/avatar12.jpg" alt="">
...
<li>
<a class="active" href="be_pages_generic_contact.php">Contact</a>
</li>
<li>
...
<ul>
<li>
<a href="be_pages_auth_all.php">All</a>
</li>
<li>
...
</header><main id="main-container"><div class="bg-primary">
<div class="bg-pattern bg-black-op-25" style="background-image: url('../png/bg-pattern.png');">
...
<form class="js-validation-be-contact" action="https://demo.pixelcave.com/codebase/be_pages_generic_contact.php" method="post">
<div class="form-group row">
<div class="col-12">
...
</footer></div><script src="../js/codebase.min-1.4.js"></script><script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAVxLoIeqnW5iqwWDOXNQ57PHPMWSqwNVU"></script>
<script src="../js/gmaps.min.js"></script>
<script src="../js/jquery.validate.min.js"></script>
<script src="../js/be_pages_generic_contact.js"></script>
