...
<!-- Mirrored from demo.pixelcave.com/codebase/be_tables_helpers.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 21:49:28 GMT -->
...
<head>
    ...
    THIS IS THE DEMO VERSION OF CODEBASE UI FRAMEWORK!
    ...
    IN THE FULL VERSION
        ...
        YOU GET A GULPFILE FOR LIVE-COMPILING SASS FILES AND BUILDING YOU OWN UI FRAMEWORK
...
<i class="fa fa-search"></i>
                ...
                <div class="block pull-r-l">
                    ...
                    <div class="block-content">
                        <ul class="nav-users push">
                            ...
                            <li>
                                <a href="be_pages_generic_profile.html">
                                    <img class="img-avatar" src="jpg/avatar10.jpg" alt="">
                            ...
                            <li>
                                <a href="be_pages_generic_profile.html">
                                    <img class="img-avatar" src="jpg/avatar2.jpg" alt="">
                ...
                <div class="block pull-r-l">
                    ...
                    <div class="block-content">
                        <form action="https://demo.pixelcave.com/codebase/be_pages_dashboard.php" method="post" onsubmit="return false;">
                    ...
                    <ul class="nav-main">
                        ...
                        <li class="open">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="active" href="be_tables_helpers.html">Helpers</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="php/be_pages_generic_contact.php">Contact</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="php/op_error_503.php">503</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="php/be_pages_auth_all.php">All</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="php/op_auth_reminder.php">Pass Reminder</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-globe"></i><span class="sidebar-mini-hide">e-Learning</span></a>
                            <ul>
                                <li>
...
<i class="fa fa-search"></i>
    ...
    </header><main id="main-container"><div class="content">
                    ...
                    <table class="js-table-sections table table-hover">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <em class="text-muted">October 26, 2017 12:16</em>
                            </td>
                        </tr>
                        </tbody>
                        <tbody>
                        <tr>
                            ...
                            <td class="font-w600 text-success">+ $282,00</td>
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $99,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 11, 2017 12:16</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $173,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $78,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $155,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 20, 2017 12:16</span>
                            </td>
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $298,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 3, 2017 12:16</span>
                            </td>
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $235,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 11, 2017 12:16</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <em class="text-muted">October 12, 2017 12:16</em>
                            </td>
                        </tr>
                        </tbody>
                        <tbody>
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $286,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 21, 2017 12:16</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $127,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 20, 2017 12:16</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <em class="text-muted">October 20, 2017 12:16</em>
                            </td>
                        </tr>
                        </tbody>
                        <tbody>
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $228,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                        ...
                        <tr>
                            <td class="text-center"></td>
                            <td class="font-w600 text-success">+ $242,00</td>
                            <td class="font-size-sm">Stripe</td>
                            <td class="d-none d-sm-table-cell">
                                <span class="font-size-sm text-muted">October 21, 2017 12:16</span>
                            </td>
                ...
                <div class="block-content">
                    <table class="js-table-checkable table table-hover">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <em class="text-muted">November 28, 2017 13:17</em>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td>
                                <p class="font-w600 mb-10">Alice Moore</p>
                                <p class="text-muted mb-0">Customer details and further information</p>
                            </td>
                            <td class="d-none d-sm-table-cell">
                                <span class="badge badge-success">VIP</span>
                            ...
                            <td class="d-none d-sm-table-cell">
                                <em class="text-muted">November 13, 2017 13:17</em>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                            ...
                            <td>
                                <p class="font-w600 mb-10">Carl Wells</p>
                                <p class="text-muted mb-0">Customer details and further information</p>
                            </td>
                            <td class="d-none d-sm-table-cell">
                                <span class="badge badge-primary">Personal</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="font-w600 mb-10">Ralph Murray</p>
                                <p class="text-muted mb-0">Customer details and further information</p>
                            </td>
                            <td class="d-none d-sm-table-cell">
    ...
    <footer id="page-footer" class="opacity-0">
        <div class="content py-20 font-size-xs clearfix">
            ...
            <div class="float-left">
                <a class="font-w600" href="https://goo.gl/po9Usv" target="_blank">Codebase 1.4</a> &copy; <span class="js-year-copy">2017</span>
            </div>
        </div>
    </footer></div><script src="js/codebase.min-1.4.js"></script><script>jQuery(function(){Codebase.helpers('table-tools');});</script>
...
<i class="fa fa-search"></i>
    ...
    <footer id="page-footer" class="opacity-0">
        <div class="content p<!doctype html>
<!--[if lte IE 9]>     <html lang="en" class="no-focus lt-ie10 lt-ie10-msg"> <![endif]-->
        <!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
...
<i class="fa fa-search"></i>
        ...
        <!-- Mirrored from demo.pixelcave.com/codebase/be_tables_helpers.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 21:49:28 GMT -->
        </html>y-20 font-size-xs clearfix">
            <div class="float-right">
                Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://goo.gl/vNS3I" target="_blank">pixelcave</a>
            </div>
            <div class="float-left">
