...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single-service">
                        ...
                        <a href="#" data-toggle="modal" data-target="skill_business">learn more</a>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="single-service">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                        <a href="#" data-toggle="modal" data-target="">learn more</a>
                    </div>
                </div>
                <!-- / END SINGLE SERVICES DESIGN AREA -->
                <!-- START SINGLE SERVICES DESIGN AREA -->
    ...
    <div id="skills-business" class="modal fade" role="dialog">
    ...
    <div id="empowerment" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
    ...
    <div id="health-services" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
    ...
    <div id="business-consultancy" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
    ...
    <div id="micro-credit" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
    ...
    <div id="legal-services" class="modal fade" role="dialog">
        <div class="modal-dialog modal-sm">
